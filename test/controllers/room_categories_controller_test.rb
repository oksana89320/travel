...
class RoomCategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create room_category" do
    assert_difference('RoomCategory.count') do
      post room_categories_url, params: { room_category: { hotel_id: @room_category.hotel_id, name: @room_category.name } }
    end
  ...
  test "should update room_category" do
    patch room_category_url(@room_category), params: { room_category: { hotel_id: @room_category.hotel_id, name: @room_category.name } }
